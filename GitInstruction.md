...
Для неотслеживаемых файлов Gitом необходимо создать новый файл с расширением ".gitignore". Затем в открывшемся окне добавить файлы, которые не должны отслеживаться. Например, для неотслеживания картинки необходимо в файл ".gitignore" добавить название данной картинки. Потом в проводнике название картинки будееееет подсвечиваться серым цветом.
## 10. Работа с ветками
### 10.1 Создание веток
### 10.2 Слияние веток
